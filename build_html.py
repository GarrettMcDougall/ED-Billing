...
def row(desc, code, price, added=False, hidden=False, badge=None, syn=None, info=None, expand=False):
    return ("ROW", desc, code, price, {
        "added": added, "hidden": hidden, "badge": badge,
        "syn": syn, "info": info, "expand": expand,
    })
...
SECTIONS = [
    ...
    ('crit', 'Critical Care', '#ef4444', [
        ...
        row('External pacing', 'G115', '$46.30', badge='gno', syn='pacer code'),
        row('Transcutaneous/transthoracic pacemaker insertion', 'G303', '$51.25', badge='g35', syn='pacing pacer code'),
        ...
        row('Cardiac massage, open (e.g. during resuscitative thoracotomy)', 'R765', '$231.30', badge='g35', syn='open cardiac massage thoracotomy code'),
    ...
    ('fx', 'Fractures', '#f59e0b', [
        ('SUB', 'No reduction'),
        row('Phalanx', 'F004', '$49.20', syn='finger toe digit'),
        row('Metacarpal', 'F008', '$49.20', syn='hand finger knuckle wrist'),
        row('Intra-articular', 'F006', '$119.75'),
        row('Carpus', 'F102', '$49.20', syn='wrist'),
        row('Scaphoid', 'F018', '$49.20'),
        row("Radius distal (Colles', Smith)", 'F027', '$67.75', syn='wrist distal radius wrist distal radius wrist'),
        row('Radius & ulnar shaft', 'F024', '$67.75'),
        row('Radius & ulna – Monteggia', 'F014', '$67.75', syn='forearm'),
        row('Radius or ulna', 'F031', '$81.30'),
        row('Epicondyle', 'F029', '$67.75', syn='elbow tennis elbow golfers elbow'),
        row('Transcondylar / condylar', 'F039', '$67.75', syn='elbow elbow'),
        row('Olecranon', 'F034', '$126.25', syn='elbow'),
        row('Humerus tuberosity', 'F047', '$67.80', syn='arm upper arm'),
        row('Humerus neck w/o head disl', 'F053', '$67.80', syn='arm upper arm'),
        row('Humeral neck w head disl', 'F050', '$67.80', syn='arm upper arm'),
        row('Humeral shaft', 'F042', '$67.80', syn='arm upper arm'),
        row('Scapula', 'F119', '$67.80', syn='shoulder blade'),
        row('Patella', 'F085', '$67.75', syn='kneecap knee'),
        row('Tibia +/- fibula', 'F078', '$115.95', syn='leg shin lower leg leg lower leg'),
        row('Fibula', 'F082', '$67.75', syn='leg lower leg'),
        row('Ankle', 'F074', '$67.75', syn='ankle sprain'),
        row('Metatarsus', 'F062', '$67.75', syn='foot toe forefoot foot ankle hindfoot'),
        row('Toe', 'F056', '$49.20'),
        row('Tarsus excluding os calcis', 'F066', '$98.10', syn='foot ankle hindfoot heel calcaneus'),
        ('SUB', 'Closed reduction'),
        row('Phalanx', 'F005', '$99.25', syn='finger toe digit'),
        row('Metacarpal', 'F009', '$99.25', syn='hand finger knuckle wrist'),
        row('Intra-articular', 'F006', '$119.75'),
        row('Carpus', 'F016', '$115.10', syn='wrist'),
        row('Radius distal (hematoma block)', 'F028', '$109.45', syn='wrist'),
        row('Radius distal (under sedation)', 'F046', '$149.35', syn='wrist'),
        row('Epicondyle', 'F037', '$126.25', syn='elbow tennis elbow golfers elbow'),
        row('Transcondylar / condylar', 'F040', '$298.35', syn='elbow elbow'),
        row('Olecranon', 'F035', '$129.00', syn='elbow'),
        row('Radius & ulnar shaft', 'F025', '$148.50'),
        row('Radius & ulna – Monteggia', 'F022', '$144.80', syn='forearm'),
        row('Radius or ulna', 'F032', '$117.85'),
        row('Humerus tuberosity', 'F048', '$117.85', syn='arm upper arm'),
        row('Humerus neck w/o head disl', 'F054', '$133.60', syn='arm upper arm'),
        row('Humeral neck w head disl', 'F051', '$183.80', syn='arm upper arm'),
        row('Humeral shaft', 'F043', '$147.60', syn='arm upper arm'),
        row('Clavicle', 'F110', '$62.20', syn='collarbone'),
        row('Sternum', 'F123', '$115.95', syn='chest breastbone'),
        row('Femur child', 'F094', '$258.00', syn='thigh upper leg'),
        row('Femur adult', 'F095', '$407.35', syn='thigh upper leg'),
        row('Tibia with or without fibula', 'F079', '$180.05', syn='leg shin lower leg leg lower leg'),
        row('Fibula', 'F083', '$101.25', syn='leg lower leg'),
        row('Ankle', 'F075', '$144.80', syn='ankle sprain'),
        row('Ankle w tibial plafond burst', 'F104', '$363.40', syn='leg shin lower leg ankle sprain'),
        row('Toe', 'F058', '$72.35'),
        row('Tarsus excluding os calcis', 'F067', '$165.20', syn='foot ankle hindfoot heel calcaneus'),
        row('Intra-articular fracture – IP joint', 'F057', '$77.95'),
        row('Metatarsus, no reduction', 'F061', '$49.20', syn='foot toe forefoot foot ankle hindfoot'),
        row('Calcaneus, no reduction', 'F070', '$97.35', syn='heel'),
        row('Phalanx (hand), open fracture', 'F007', '$346.50', syn='finger toe digit'),
        row('Phalanx (hand) fracture, each additional', 'E558', '$22.25', syn='finger toe digit'),
        row('Phalanx (foot) fracture, each additional', 'E560', '$12.05', syn='finger toe digit'),
        row('Metacarpal fracture, each additional', 'E577', '$10.25', syn='hand finger knuckle wrist'),
        row('Toe fracture, each additional', 'E578', '$10.25'),
        row('Nasal bone – closed reduction', 'F136', '$102.35', syn='nose broken nose'),
        row('Nasal bone – open reduction', 'F137', '$316.35', hidden=True, syn='nose broken nose'),
    ]),
...
def render_entry(entry):
    ...
    if kind == "ROW":
        ...
        out = (f'<div class="{cls}" data-code="{code.lower()}" data-desc="{d.lower()}" '
               ...
               f'<span class="desc">{d}{badge_html}{new_html}{exp_hint}</span>'
